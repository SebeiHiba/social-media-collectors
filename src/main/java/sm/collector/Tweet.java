...
public class Tweet {
    ...
    private static final String CONSUMER_KEY = "lfG9n2OmS6u3vHJrL8NfslW1h";
    private static final String CONSUMER_SECRET = "EsT591XHkLnpO19kfywN1XsTHAvHCCYHnOkvahiiZ8Bw4fxxql";
    ...
    public static Twitter getTwitter() {
        Authenticator.setDefault(new ProxyAuthenticator("05376263", "rana05376263"));
